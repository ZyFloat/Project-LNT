...
<div class="mb-10 flex items-center space-x-4">
    ...
    <div>
        <h1 class="text-3xl font-bold tracking-tight text-slate-900">Edit Employee</h1>
        <p class="text-slate-500">Update details for {{ $employee->name }}.</p>
    </div>
</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" id="address" rows="3" required
                        ...
                        placeholder="Enter full organizational address...">{{ old('address', $employee->address) }}</textarea>
